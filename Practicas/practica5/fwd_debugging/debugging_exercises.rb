...
require 'rspec'
  ...
  puts decrement_smallest_value(lista_anidada)
  ...
  puts increment_greatest_value(lista_anidada2)
  ...
  puts isogram?('Vale')   # si se repite letra pone falso si no se repite pone true
